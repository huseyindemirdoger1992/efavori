...
namespace data._Product
{
    ...
    public class Products
    {
        ...
        // === AI Ä°Ã§erik YÃ¶netimi ===
        // SatÄ±cÄ± Ã¼rÃ¼n eklerken "AI YÃ¶netimine Ä°zin Ver" toggle'Ä±nÄ± aÃ§arsa true olur.
        public bool? IsAiManaged { get; set; } = false; // SatÄ±cÄ± AI yÃ¶netimine izin veriyor mu

        // null â†’ AI yÃ¶netimi yapÄ±lmadÄ± (IsAiManaged=false) | true â†’ AI tarafÄ±ndan baÅŸarÄ±yla oluÅŸturuldu | false â†’ AI iÅŸlemi baÅŸarÄ±sÄ±z oldu
        public bool? AiContentStatus { get; set; } // AI iÅŸlem durumu

        // SatÄ±cÄ±nÄ±n orijinal giriÅŸi â€” AI kapatÄ±lÄ±rsa geri yÃ¼klenir
        ...
        public string? AiErrorMessage { get; set; }          // Son hata mesajÄ± (Failed durumunda)
        public int AiRetryCount { get; set; } = 0;           // Tekrar deneme sayÄ±sÄ±
        public DateTime? AiProcessedAt { get; set; }         // AI'Ä±n iÅŸlemi tamamladÄ±ÄŸÄ± an
