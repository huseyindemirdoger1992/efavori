!(function (e, t) {
    ...
    function st() {
        nt &&
            (!1 === v.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(st) : e.setTimeout(st, w.fx.interval),
                w.fx.tick());
    }
    function ut() {
        return (
    ...
    w.ajaxSetup({
        ...
        (d.createHTMLDocument =
            (((Ut = v.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"),
